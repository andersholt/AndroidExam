...
class ItemViewHolder(private val view:View) : RecyclerView.ViewHolder(view)
    ...
    override fun onBindViewHolder(holder: ItemViewHolder, position: Int) {
        ...
        (((holder.itemView as LinearLayout).getChildAt(0) as LinearLayout).getChildAt(0) as TextView).text =
            "Mjau"
        ((holder.itemView.getChildAt(0) as LinearLayout).getChildAt(1) as ImageView).setBackgroundColor(Color.BLACK)
