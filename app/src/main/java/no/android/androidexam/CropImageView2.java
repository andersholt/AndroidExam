...
import no.android.androidexam.fragments.Fragment1Child1;
import no.android.androidexam.util.AspectRatioUtil;
import no.android.androidexam.util.HandleUtil;
import no.android.androidexam.util.PaintUtil;
...
public class CropImageView2 extends androidx.appcompat.widget.AppCompatImageView {
    ...
    private Fragment1Child1.OnImageSizeChangedListener onImageSizeChangedListener;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_DOWN:
                actionDown = new float[]{event.getX(), event.getY()};

                onActionDown(event.getX(), event.getY());
                return true;

            case MotionEvent.ACTION_UP:
                actionUp = new float[]{event.getX(), event.getY()};

                if (actionDown[0] == actionUp[0] && actionDown[1] == actionUp[1])
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                this.onImageSizeChangedListener.onImageSizeChanged(getCroppedRect());
                return true;
    ...
    public Rect getCroppedRect() {
        ...
        return new Rect((int) cropX, (int) cropY, (int) cropWidth, (int) cropHeight);
    ...
    public void setListeners(@NotNull OnClickListener onClickListener, @NotNull Fragment1Child1.OnImageSizeChangedListener onImageSizeChangedListener) {
        this.onClickListener = onClickListener;
        this.onImageSizeChangedListener = onImageSizeChangedListener;
    }
}